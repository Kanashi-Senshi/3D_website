...
const InteractiveModel: React.FC = () => {
  const controls = useMemo<ControlButtonProps[]>(
    () => [
      {
        icon: (
          <svg width="20" height="20" viewBox="0 0 356.572 356.572" fill="currentColor">
            <path
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.controlsContainer}>
        {controls.map((control: ControlButtonProps, index: number) => (
