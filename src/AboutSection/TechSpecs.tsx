...
const SpecificationBlock: React.FC<SpecificationProps> = ({ title, items, icon }) => (
...
const TechSpecs: React.FC = () => {
  const specifications = useMemo<SpecificationProps[]>(
    () => [
      {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.grid}>
        {specifications.map((spec: SpecificationProps, index: number) => (
