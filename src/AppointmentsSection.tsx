...
const AppointmentsSection: React.FC<AppointmentsSectionProps> = ({ userType, currentUserName }) => {
  ...
  const doctors: Array<Doctor> = useMemo(
    () => [
      { id: '1', name: 'Medion' },
  ...
  }, [appointments, userType, currentUserName]);
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        {userType === 'patient' && (
          <button onClick={() => setShowScheduleModal(true)} style={styles.scheduleButton}>
            <Calendar size={20} />
